 ...
 */
MboxFifoCtrl *vpi_mbox_init(MboxCoreId core_id, uint64_t shm_addr,uint64_t shm_addr_phy, uint64_t shm_block_size/*,int fd*/);
 ...
 */
int vpi_mbox_post(MboxFifoCtrl *mbox_fifo,  MboxPostMsg *msg, MboxCoreId receiver_id/*,int fd*/,
 ...
 * @retval MBOX_SUCCESS for succeed, others for failure
 */
int vpi_mbox_broadcast(MboxFifoCtrl *mbox_fifo, MboxPostMsg *msg, /*,int fd*/
                       MboxDriverCb mbox_driver_cb);
 ...
 * @retval MBOX_SUCCESS for succeed, others for failure
 */
int vpi_mbox_read(MboxFifoCtrl *mbox_fifo, MboxPostMsg *msg, MboxCoreId sender_id/*,int fd*/);
