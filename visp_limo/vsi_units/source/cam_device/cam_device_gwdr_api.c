								 ...
								 CamDeviceGWdrConfig_t *pGWdrCfg)
{
	...
	result = Send_Command(APU_2_RPU_MB_CMD_GWDR_SET_CONFIG, &packet,
								 ...
								 CamDeviceGWdrConfig_t *pGWdrCfg)
{
	...
	result = Send_Command(APU_2_RPU_MB_CMD_GWDR_GET_CONFIG, &packet,
						  packet.payload_size + payload_extra_size, dest_cpu_id,
						  src_cpu_id);
	if (0 != result)
	{
...
RESULT VsiCamDeviceGWdrEnable(CamDeviceHandle_t hCamDevice)
{
	...
	result = Send_Command(APU_2_RPU_MB_CMD_GWDR_ENABLE, &packet,
						  packet.payload_size + payload_extra_size, dest_cpu_id,
						  src_cpu_id);
	if (0 != result)
	{
...
RESULT VsiCamDeviceGWdrDisable(CamDeviceHandle_t hCamDevice)
{
	...
	result = Send_Command(APU_2_RPU_MB_CMD_GWDR_DISABLE, &packet,
						  packet.payload_size + payload_extra_size, dest_cpu_id,
						  src_cpu_id);
	if (0 != result)
	{
								 ...
								 CamDeviceGWdrStatus_t *pGWdrStatus)
{
	...
	result = Send_Command(APU_2_RPU_MB_CMD_GWDR_GET_STATUS, &packet,
						  packet.payload_size + payload_extra_size, dest_cpu_id,
						  src_cpu_id);
	if (0 != result)
	{
...
RESULT VsiCamDeviceGWdrReset(CamDeviceHandle_t hCamDevice)
{
	...
	result = Send_Command(APU_2_RPU_MB_CMD_GWDR_RESET, &packet,
						  packet.payload_size + payload_extra_size, dest_cpu_id,
						  src_cpu_id);
	if (0 != result)
	{
								  ...
								  uint32_t *pVersion)
{
	...
	result = Send_Command(APU_2_RPU_MB_CMD_GWDR_GET_VERSION, &packet,
						  packet.payload_size + payload_extra_size, dest_cpu_id,
						  src_cpu_id);
	if (0 != result)
	{
