									 ...
									 IsiSensorHandle_t *pSensorHandle)
{
	...
	{
		printf("%s: isi sensor handle already exist!\n", __func__);
	...
	{
		printf("%s: isi get sensor function pointer error %d!\n", __func__,
			   result);
	...
	{
		printf("%s: isi get sensor handle failed %d!\n", __func__, result);
		osFree(instConfig.pSensor);
		return RET_FAILURE;
	}
							  ...
							  IsiExpDecomposeResult_t *pDecResult)
{
	...
	result = pSensorCtx->pSensor->pIsiExpDecomposeCtrlIss(pSensorCtx, pDecParam,
														  pDecResult);
...
RESULT IsiSetFpsIss(IsiSensorHandle_t handle, uint32_t fps)
{
	...
	{
		printf("%s: pIsiSetFpsIss is NULL\n", __func__);
		return (RET_NOTSUPP);
	}
...
RESULT IsiGetIspStatusIss(IsiSensorHandle_t handle, IsiIspStatus_t *pIspStatus)
{
	...
	{
		printf("%s: pIsiGetIspStatusIss is NULL\n", __func__);
		return (RET_NOTSUPP);
	}
							   ...
							   IsiFocusCalibAttr_t *pFocusCalib)
{
	...
	result =
		pSensorCtx->pSensor->pIsiFocusGetCalibrateIss(pSensorCtx, pFocusCalib);
								   ...
								   IsiMetadataAttr_t attr)
{
	...
	result =
		pSensorCtx->pSensor->pIsiSetMetadataAttrEnableIss(pSensorCtx, attr);
								   ...
								   IsiMetadataAttr_t *pAttr)
{
	...
	result =
		pSensorCtx->pSensor->pIsiGetMetadataAttrEnableIss(pSensorCtx, pAttr);
							...
							IsiSensorMetadata_t *pMetaInfo)
{
	...
	result = pSensorCtx->pSensor->pIsiParserMetadataIss(pSensorCtx, pMetaBuf,
														pMetaInfo);
