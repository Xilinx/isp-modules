...
#define MAX9295_TABLE_END                       (0xffff)
#define MAX9295_TABLE_WAIT              (0xfffe)
#define MAX9295_TABLE_WAIT_MS           (210)
...
#define OX03F10_MIN_FRAME_RATE			(37)
...
struct reg_8 serializer_initialization_a[] = {
	{0x0053, 0x10},
	{0x0057, 0x11},
	{0x005B, 0x12},
	{0x005F, 0x13},
	...
	/* Enable CSI port B, port B selection for video pipeline Y */
	{0x0308, 0x7F},
	...
	{MAX9295_TABLE_WAIT, MAX9295_TABLE_WAIT_MS},
	{MAX9295_TABLE_END, 0}
};

struct reg_8 serializer_initialization_b[] = {
	{0x0053, 0x10},
	{0x0057, 0x12},
	{0x005B, 0x11},
	{0x005F, 0x13},
